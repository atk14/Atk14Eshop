...
CREATE TABLE delivery_methods (
	...
	CONSTRAINT chk_deliverymethods_prices CHECK ((price IS NOT NULL AND price_incl_vat IS NOT NULL) OR (price IS NULL AND price_incl_vat IS NULL)),
