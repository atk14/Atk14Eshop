...
export class SimpleMap {
  ...
  map;
  marker;
  iconOptions = MapHelpers.iconOptions;
  baseMapLayer;
  ...
  constructor( mapElement) {
    ...
    this.baseMapLayer = L.tileLayer( MapHelpers.mapProvider, { 
      attribution: MapHelpers.mapAttribution 
    } );
    ...
    MapHelpers.addTileProviderLogo( this.map );
  }
}
...
/*window.UTILS.customMapIcon = L.Icon.extend( {
  options: MapHelpers.iconOptions
} );*/
