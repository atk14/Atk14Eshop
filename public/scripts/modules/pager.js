...
Pager.prototype.reinit = function( ) {
...
Pager.prototype.updateButton = function( button, url, text, amount ) {
...
Pager.prototype.updateNextButton = function() {
	var url, text;
...
Pager.prototype.newPageSize = function() {
	return this.pagingPer === "section" ? this.sectionSize : this.pageSize ;
};

Pager.prototype.updatePager = function( data, options ) {
	if ( data.pageSize ) {
...
Pager.prototype.click = function( button ) {
...
Pager.prototype.doPaging = function( href, button, updatePagerOptions ) {
