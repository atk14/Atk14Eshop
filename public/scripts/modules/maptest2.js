...
import L from "leaflet";// "../../../node_modules/leaflet/dist/leaflet-src.esm.js";
...
export class MapTest extends MapBase {
  constructor() {
    super();
      ...
      console.log( "MapTest constructor" );
  ...
  createMap( mapElement ) {
    ...
    let zoom = mapElement.dataset.zoom;
    let title = mapElement.dataset.title;
    console.log( lat, lng, zoom, title );
    console.log( "L", L );
    //let L = window.L;
    // Create basemap tile layer
    let baseMapLayer = L.tileLayer( MapBase.mapProvider, { 
      attribution: MapBase.mapAttribution 
    } );
    console.log( "baseMapLayer", baseMapLayer );
    console.log( "mapProvider", MapBase.mapProvider );
    console.log( "mapAttribution", MapBase.mapAttribution );
