...
( function( window, undefined ) {
	...
	window.UTILS.deliveryServiceBranchSelector = {
		setAutocomplete: function( element, options ) {
			...
			targetElement.parent( "form" ).on( "submit", function() {
		...
		init: function() {
			...
			this.setAutocomplete( $( "#id_post_office_q" ), {
				target_element_id: "#id_post_office_id"
			} );
		},
	...
	$( "#form_checkouts_set_payment_and_delivery_method" + " " + selectorBranchNeededField)
		...
		.bind( "change.delivery", window.UTILS.deliveryServiceBranchSelector.performClick );
} )( this );
