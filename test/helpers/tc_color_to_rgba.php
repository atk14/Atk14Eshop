...
class TcColorToRgba extends TcBase {
	...
	function test(){
		...
		$this->assertEquals("rgba(0,17,255,1.0)",smarty_modifier_color_to_rgba("#0011FFAA")); // hexa
		...
		$this->assertEquals("rgba(33,44,55,1.0)",smarty_modifier_color_to_rgba("rgba(33,44,55,0.3)"));
		$this->assertEquals("rgba(33.3,44.4,55.5,0.5)",smarty_modifier_color_to_rgba("rgba(33.3, 44.4, 55.5, 0.3)","0.5"));
