<div class="form__body{if !$fill_in_invoice_address} nojs-only{/if}" id="invoice-address-fields">
	...
	{render partial="shared/form_field" fields="firstname,lastname,company,company_number,vat_id"}
	{if $form->has_field("local_vat_id")}
		{render partial="shared/form_field" fields="local_vat_id"}
	{/if}
	{render partial="shared/form_field" fields="address_street,address_city"}
