...
<body style="word-spacing:normal;background-color:{$bg_color};">
  ...
  <div aria-roledescription="email" style="background-color:{$bg_color};" role="article" lang="und" dir="auto">
    ...
    <!--[if mso | IE]></td></tr></table><![endif]--> {if $message_type == "notify_order_creation" } <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:white;background-color:white;width:100%;">
      <tbody>
        <tr>
          <td>
