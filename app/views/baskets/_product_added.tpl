...
<div class="section__navigation">
	<button class="btn btn-primary btn--back" data-dismiss="modal">{t}Vybrat další produkt{/t}</button>
	<a href="{link_to action="baskets/edit"}" class="btn btn--cta">{t}K pokladně{/t}</a>
</div>
