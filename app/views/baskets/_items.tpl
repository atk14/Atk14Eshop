		...
		<tbody class="table-products__list">
			...
			{foreach $basket->getItems() as $item}
				...
				<tr class="table-products__item">
					<td class="table-products__image"><a href="{$product|link_to_product}" aria-label="{$product->getName()} - {t}Product detail{/t}">{render partial="shared/product_image" product=$product}</a></td>
