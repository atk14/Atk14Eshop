...
{*assign object_class $order|get_class*}
	...
	{if $delivery_method_data}
		...
		{capture assign=delivery_service_branch_info}
			{t 1=$delivery_address.company 2=$delivery_address.zip 3=$delivery_address.city 4=$delivery_address.street}Pobočka: %1, %2, %3, %4{/t}{if $show_branch_id} ({t 1=$delivery_method_data.external_branch_id}ID pobočky: %1{/t}){/if}
		{/capture}
	{/if}
{/trim}
