<div class="">
	...
	<a href="{$pager->nextPageUrl()}" class="list__item js--next next-page btn btn-primary {if !$pager->nextPage()}disabled{/if}" rel="nofollow">{$pager->getText('next_page', $pager->getRemains())} {!"chevron-right"|icon}</a>
</div>
