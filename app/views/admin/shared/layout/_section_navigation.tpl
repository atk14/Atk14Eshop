<form class="form-inline" id="nav-filter">
	<input class="form-control form-control-sm" id="nav-filter__input">
	<button class="btn btn-sm btn-link d-none" id="nav-filter__clear">{!"times"|icon}</button>
	<button class="btn btn-sm btn-link" id="nav-filter__submit">{!"search"|icon}</button>
</form>
