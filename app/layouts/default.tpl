...
<html lang="{$lang}" class="no-js">
	...
	<body class="body_{$controller}_{$action}" data-controller="{$controller}" data-action="{$action}">
		...
		<div id="js--suggesting" style="width: 800px; height: 600px; position: absolute; left: 200px; top: 200px; background-color: green; z-index: 10; overflow: scroll; display: none;"></div>
